function criarApresentacao() {
    /* var texto1 = document.getElementById('texto1').value.replace(/(^\w{1})|(\s+\w{1})/g, letra => letra.toUpperCase()); */
    ...
    if(!(nomeSobrenome.test(document.getElementById('texto1').value))){
        ...
        window.alert("Verifique se seu nome está no padrão correto dentro do campo Nome do professor.\n\nExemplo:\n\tAugusto da Silva Soares\n\tAna de Melo Lopez");
}
}
