...
function criarApresentacao1_1() {
    ...
    var texto1_2 = document.getElementById('texto1_2').value.replace(/(\r\n|\n|\r)/gm, "</p>\n\<p  style='text-align: left; color: #444444;'>").replaceAll("<p  style='text-align: left; color: #444444;'></p>", "<br>");
    var texto1_3 = document.getElementById('texto1_3').value.replaceAll("&ab_channel","_channel");
    if (texto1_1 == "" & texto1_2 == "" & texto1_3 == "") {
        ...
        document.getElementById('copiar1_1').value = "<div style='text-align: center; font-size: 18px; padding: 15px; border: 1px solid #d7dfe3; border-radius: 15px; background-color:  #0f96ae41; background-color:  #ef7b0013;'><div style='display: grid; grid-template-columns: 350px auto;'><div style='margin: auto; padding-right: 5px;'><img src='https://drive.google.com/file/d/1z_DWpv3QFqRle7AW1sJnVo7o1raRZ19G/view?usp=sharing' alt='Local para inserir a Imagem' width='480' height='640' style='width: 320px; height: 320px; border-radius: 50%; border: 1px solid #d7dfe3; background-color: #ffffff;'><p style='text-align: center; color: #FF7514; font-weight: bold; font-size: 22px;'>" + texto1_1 + "</p></div><div style='margin: auto; padding-left: 5px;'><p style='text-align: left; color: #444444;'>" + texto1_2 + "</p></div></div></div>";
        ...
        if (texto1_3.substr(0, 32) == "https://www.youtube.com/watch?v=") {
            ...
            document.getElementById('copiar1_1').value = "<div style='text-align: center; font-size: 18px; padding: 15px; border: 1px solid #d7dfe3; border-radius: 15px; background-color:  #0f96ae41; background-color:  #ef7b0013;'><div style='display: grid; grid-template-columns: 350px auto;'><div style='margin: auto; padding-right: 5px;'><img src='https://drive.google.com/file/d/1z_DWpv3QFqRle7AW1sJnVo7o1raRZ19G/view?usp=sharing' alt='Local para inserir a Imagem' width='480' height='640' style='width: 320px; height: 320px; border-radius: 50%; border: 1px solid #d7dfe3; background-color: #ffffff;'><p style='text-align: center; color: #FF7514; font-weight: bold; font-size: 22px;'>" + texto1_1 + "</p></div><div style='margin: auto; padding-left: 5px;'><p style='text-align: left; color: #444444;'>" + texto1_2 + "</p></div></div><hr style='width: 90%; color: #FF7514;'><div style='display: inline;'><div style='margin: auto;'><p style='text-align: center; color: #FF7514; font-weight: bold; font-size: 20px;'>Vídeo do professor:</p></div><div style='margin: auto 0px;'><p style='text-align: center;'><iframe style='border-radius: 8px; border: 1px solid #ffffff00;' src='" + video + "'width='540'  height='380' allow='autoplay'></iframe></p> </div></div></div>";
...
function criarApresentacao2_1() {
    ...
    if (texto2_1 == "" & texto2_2 == "" & texto2_3 == "") {
        ...
        document.getElementById('copiar2_1').value = "<div style='text-align: center; font-size: 18px; padding: 15px; border: 1px solid #d7dfe3; border-radius: 15px; background-color:  #0f96ae41; background-color:  #ef7b0013;'><div style='display: grid; grid-template-columns: 350px auto;'><div style='margin: auto; padding-right: 5px;'><img src='https://drive.google.com/file/d/1z_DWpv3QFqRle7AW1sJnVo7o1raRZ19G/view?usp=sharing' alt='Local para inserir a Imagem' width='480' height='640' style='width: 320px; height: 320px; border-radius: 50%; border: 1px solid #d7dfe3; background-color: #ffffff;'><p style='text-align: center; color: #FF7514; font-weight: bold; font-size: 22px;'>" + texto2_1 + "</p></div><div style='margin: auto; padding-left: 5px;'><p style='text-align: left; color: #444444;'>" + texto2_2 + "</p></div></div></div>";
        ...
        if (texto2_3.substr(0, 32) == "https://www.youtube.com/watch?v=") {
            ...
            document.getElementById('copiar2_1').value = "<div style='text-align: center; font-size: 18px; padding: 15px; border: 1px solid #d7dfe3; border-radius: 15px; background-color:  #0f96ae41; background-color:  #ef7b0013;'><div style='display: grid; grid-template-columns: 350px auto;'><div style='margin: auto; padding-right: 5px;'><img src='https://drive.google.com/file/d/1z_DWpv3QFqRle7AW1sJnVo7o1raRZ19G/view?usp=sharing' alt='Local para inserir a Imagem' width='480' height='640' style='width: 320px; height: 320px; border-radius: 50%; border: 1px solid #d7dfe3; background-color: #ffffff;'><p style='text-align: center; color: #FF7514; font-weight: bold; font-size: 22px;'>" + texto2_1 + "</p></div><div style='margin: auto; padding-left: 5px;'><p style='text-align: left; color: #444444;'>" + texto2_2 + "</p></div></div><hr style='width: 90%; color: #FF7514;'><div style='display: inline;'><div style='margin: auto;'><p style='text-align: center; color: #FF7514; font-weight: bold; font-size: 20px;'>Vídeo do coordenador:</p></div><div style='margin: auto 0px;'><p style='text-align: center;'><iframe style='border-radius: 8px; border: 1px solid #ffffff00;' src='" + video + "'width='540'  height='380' allow='autoplay'></iframe></p> </div></div></div>";
